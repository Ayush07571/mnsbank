...
export const metadata: Metadata = {
  title: 'Professional Loan | MNS Bank',
  description: 'Get professional loans at competitive interest rates with flexible repayment options from MNS Bank Bhopal',
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-white/90">
                Advance your professional practice with MNS Bank's professional loans. Get competitive interest rates, quick approval, and flexible repayment options for doctors, lawyers, architects, and other professionals.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-white/80">Competitive rates starting from 11.5%</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="container mx-auto px-4 max-w-6xl py-12">
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Professional Loan Features</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div>
                ...
                <ul className="space-y-3 text-text-secondary">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Loan Amount: ₹5 Lakhs to ₹50 Lakhs</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Professions We Support</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6 border border-border rounded-lg">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Medical Professionals</h3>
                <p className="text-text-secondary text-sm">Doctors, dentists, surgeons</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Legal Professionals</h3>
                <p className="text-text-secondary text-sm">Lawyers, advocates, consultants</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Technical Professionals</h3>
                <p className="text-text-secondary text-sm">Engineers, architects, designers</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Financial Professionals</h3>
                <p className="text-text-secondary text-sm">CAs, CFAs, financial advisors</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Other Professionals</h3>
                <p className="text-text-secondary text-sm">Teachers, consultants, trainers</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-12">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Professional Requirements</h3>
                <ul className="space-y-2 text-text-secondary">
                  <li>• Age: 21 to 65 years</li>
                  <li>• Minimum professional experience: 3 years</li>
                  <li>• Valid professional degree/certificate</li>
                  <li>• Professional registration (if applicable)</li>
                  <li>• Stable practice/business</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Financial Requirements</h3>
                <ul className="space-y-2 text-text-secondary">
                  <li>• Minimum annual income: ₹3 Lakhs</li>
                  <li>• Good credit score (650+)</li>
                  <li>• Stable income source</li>
                  <li>• Required professional documents</li>
        ...
        <Card className="mb-12">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Professional Documents</h3>
                <ul className="space-y-2 text-text-secondary">
                  <li>• Professional degree/certificate</li>
                  <li>• Professional registration proof</li>
                  <li>• Practice establishment proof</li>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-text-secondary mb-8 max-w-2xl mx-auto">
              Apply for MNS Bank professional loan today and get competitive interest rates, quick approval, and flexible repayment options for your professional growth.
            </p>
