...
export const metadata: Metadata = {
  title: 'Time Deposit | MNS Bank',
  description: 'Get attractive interest rates on time deposits with MNS Bank. Secure investment with flexible tenure options and guaranteed returns',
};
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-white/90">
                Secure your savings with MNS Bank's time deposit scheme. Enjoy attractive interest rates, flexible tenure options, and guaranteed returns for your financial goals.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-white/80">Rates up to 7.5% p.a.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="text-center">
                ...
                <h3 className="font-heading text-xl font-semibold mb-2">Guaranteed Returns</h3>
                <p className="text-white/80">Secure investment option</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 max-w-6xl py-12">
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Interest Calculator</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 border border-border rounded-lg">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="font-medium">Maturity Amount</span>
                      <span className="text-brand-accent font-semibold">₹7,87,500</span>
                    </div>
                  </div>
                  <div className="p-4 border border-border rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="font-medium">Maturity Amount</span>
                      <span className="text-brand-accent font-semibold">₹20,00,000</span>
                    </div>
                  </div>
                </div>
              </div>
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Interest Payment Options</h3>
                <div className="space-y-3">
                  <div className="p-3 border border-border rounded-lg">
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-medium">Monthly Interest</span>
                      <span className="text-sm text-brand-accent">Available</span>
                    </div>
                  </div>
                  <div className="p-3 border border-border rounded-lg">
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-medium">Quarterly Interest</span>
                      <span className="text-sm text-brand-accent">Available</span>
                    </div>
                  </div>
                  <div className="p-3 border border-border rounded-lg">
