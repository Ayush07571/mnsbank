...
export const metadata: Metadata = {
  ...
  description:
    'Get consumer loans for all your needs at competitive interest rates with quick approval from MNS Bank Bhopal',
};
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-white/90">
                Fulfill all your dreams with MNS Bank&apos;s consumer loans. Get
                competitive interest rates, quick approval, and flexible
                repayment options for all your needs.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6 border border-border rounded-lg">
                ...
                <p className="text-text-secondary text-sm">
                  Higher education and course fees
                </p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm12 12H4l2-2h8l2 2z"
                      clipRule="evenodd"
                    />
                  </svg>
                </div>
              ...
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  >
                    ...
                    <path
                      fillRule="evenodd"
                      d="M4 5a2 2 0 012-2 1 1 0 000 2H6a2 2 0 00-2 2v6a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2a1 1 0 100-2 1 1 0 000-2h2a4 4 0 014 4v6a4 4 0 01-4 4H6a4 4 0 01-4-4V7a4 4 0 014-4z"
                      clipRule="evenodd"
                    />
                  </svg>
                </div>
                ...
                <p className="text-text-secondary text-sm">
                  Holiday packages and travel expenses
                </p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-text-secondary text-sm">
                  Wedding, celebrations, and other needs
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-text-secondary mb-8 max-w-2xl mx-auto">
              Apply for MNS Bank consumer loan today and get competitive
              interest rates with quick approval and flexible repayment options.
            </p>
