...
export const metadata: Metadata = {
  ...
  description:
    'View MNS Bank tender opportunities and procurement notices. Participate in our tender process for goods, services, and works.',
  keywords:
    'tenders, procurement, bank tenders, vendor registration, supplier opportunities, MNS Bank procurement',
};
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 text-white/90 max-w-3xl mx-auto">
              Explore tender opportunities with MNS Bank. We welcome qualified
              vendors and suppliers to participate in our transparent
              procurement process.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-text-secondary text-sm mb-2">
                      Cash replenishment and maintenance services for ATMs
                    </p>
                  </div>
                  <Button variant="outline" size="sm" asChild>
                    <Link href="/contact-us">View Details</Link>
                  </Button>
                </div>
              ...
              <div className="border rounded-lg p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="font-semibold text-text-primary mb-2">
                      Bank Stationery Supply
                    </h3>
                    <p className="text-brand-accent font-semibold mb-2">
                      Goods
                    </p>
                    <p className="text-text-secondary text-sm mb-2">
                      Supply of bank stationery, forms, and marketing materials
                    </p>
                  </div>
                  <Button variant="outline" size="sm" asChild>
                    <Link href="/contact-us">View Details</Link>
              ...
              <div className="border rounded-lg p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-text-secondary text-sm mb-2">
                      Network infrastructure and server upgradation at branches
                    </p>
                  </div>
                  <Button variant="outline" size="sm" asChild>
                    <Link href="/contact-us">View Details</Link>
              ...
              <div className="border rounded-lg p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-text-secondary text-sm mb-2">
                      Security guard services for bank branches and ATMs
                    </p>
                  </div>
                  <Button variant="outline" size="sm" asChild>
                    <Link href="/contact-us">View Details</Link>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-text-secondary mb-8 max-w-2xl mx-auto">
              For tender-related queries, vendor registration, or procurement
              information, please contact our Procurement Department.
            </p>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="text-text-secondary">
                  Procurement Department, MNS Bank Head Office
                </p>
              </div>
            </div>
          </CardContent>
