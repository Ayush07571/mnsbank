    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 max-w-6xl py-12">
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Working Capital Loan Features</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Use Working Capital For</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6 border border-border rounded-lg">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Inventory Purchase</h3>
                <p className="text-text-secondary text-sm">Stock up on raw materials and goods</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Salaries & Wages</h3>
                <p className="text-text-secondary text-sm">Pay employee salaries and wages</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Marketing & Sales</h3>
                <p className="text-text-secondary text-sm">Fund marketing and sales activities</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Business Expansion</h3>
                <p className="text-text-secondary text-sm">Expand your business operations</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Technology Upgrade</h3>
                <p className="text-text-secondary text-sm">Upgrade equipment and technology</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-12">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Business Requirements</h3>
        ...
        <Card className="mb-12">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Owner Documents</h3>
                <ul className="space-y-2 text-text-secondary">
          ...
          <CardContent>
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-text-secondary text-sm">Fill business loan application form</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-text-secondary text-sm">Submit business and financial documents</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <h4 className="font-semibold text-text-primary mb-2">Business Evaluation</h4>
                <p className="text-text-secondary text-sm">Our team evaluates your business</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
