...
export const metadata: Metadata = {
  title: 'Business Double Deposit | MNS Bank',
  description: 'Double your business investment with MNS Bank\'s business double deposit scheme. Get attractive returns for your business funds',
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="outline" size="lg" className="px-8 border-white text-white hover:bg-white hover:text-brand-primary" asChild>
                  <Link href="/contact-us">Calculate Returns</Link>
                </Button>
              </div>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-white/80">Double your business investment</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="container mx-auto px-4 max-w-6xl py-12">
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Business Double Deposit Features</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div>
                ...
                <ul className="space-y-3 text-text-secondary">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Investment Amount: ₹50,000 to No Limit</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Business Returns Calculator</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 border border-border rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-medium">Investment Amount</span>
                      <span className="text-brand-accent font-semibold">₹25,00,000</span>
                    </div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-medium">Tenure</span>
                      <span className="text-text-secondary">84 months</span>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="font-medium">Maturity Amount</span>
                      <span className="text-brand-accent font-semibold">₹50,00,000</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            <h2 className="font-heading text-2xl font-bold text-text-primary mb-4">
              Ready to Double Your Business Investment?
            </h2>
            <p className="text-text-secondary mb-8 max-w-2xl mx-auto">
              Open a MNS Bank business double deposit scheme today and double your business funds with guaranteed returns and secure investment options.
            </p>
