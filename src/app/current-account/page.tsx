...
export const metadata: Metadata = {
  title: 'Current Account | MNS Bank',
  description: 'Open a current account with MNS Bank and enjoy business banking services, overdraft facility, and digital banking',
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-heading text-xl font-semibold mb-2">Unlimited Transactions</h3>
                <p className="text-white/80">No transaction limits</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-heading text-xl font-semibold mb-2">Overdraft Facility</h3>
                <p className="text-white/80">Flexible credit limit</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-heading text-xl font-semibold mb-2">Digital Banking</h3>
                <p className="text-white/80">24/7 online services</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 max-w-6xl py-12">
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Current Account Types</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6 border border-border rounded-lg">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Basic Current</h3>
                <p className="text-text-secondary text-sm mb-4">For small businesses</p>
              ...
              <div className="text-center p-6 border border-border rounded-lg">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Premium Current</h3>
                <p className="text-text-secondary text-sm mb-4">For growing businesses</p>
                <ul className="text-sm text-text-secondary space-y-1">
                  <li>• Minimum balance: ₹10,000</li>
                  <li>• Free unlimited transactions</li>
                  <li>• Priority banking</li>
                </ul>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Business Current</h3>
                <p className="text-text-secondary text-sm mb-4">For large enterprises</p>
                <ul className="text-sm text-text-secondary space-y-1">
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Account Features & Benefits</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Banking Features</h3>
                <ul className="space-y-3 text-text-secondary">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Unlimited transactions (NEFT, RTGS, IMPS)</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>Free cheque book and pay-in slips</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  ...
                  <li className="flex items-start space-x-2">
                    ...
                    <span>UPI and instant money transfers</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3 text-text-secondary">
                  ...
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Business debit card with benefits</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <ul className="space-y-2 text-text-secondary">
                  ...
                  <li>• Valid KYC of authorized signatories</li>
                </ul>
              </div>
            </div>
          </CardContent>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <ul className="space-y-2 text-text-secondary">
                  ...
                  <li>• Identity and address proof of partners/directors</li>
                </ul>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Account Opening Process</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-text-primary mb-2">Choose Account</h4>
                <p className="text-text-secondary text-sm">Select the right current account</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-text-primary mb-2">Initial Deposit</h4>
                <p className="text-text-secondary text-sm">Make initial deposit (if applicable)</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <h4 className="font-semibold text-text-primary mb-2">Account Activated</h4>
                <p className="text-text-secondary text-sm">Get your account details and kit</p>
              </div>
            </div>
          </CardContent>
        </Card>
