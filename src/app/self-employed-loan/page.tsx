...
export const metadata: Metadata = {
  title: 'Self Employed Loan | MNS Bank',
  description: 'Get self employed loans at competitive interest rates with flexible repayment options from MNS Bank Bhopal',
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-white/90">
                Fuel your entrepreneurial journey with MNS Bank&apos;s self-employed loans. Get competitive interest rates, quick approval, and flexible repayment options for your business growth.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-white/80">Competitive rates starting from 13.5%</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="container mx-auto px-4 max-w-6xl py-12">
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Self Employed Loan Features</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div>
                ...
                <ul className="space-y-3 text-text-secondary">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Loan Amount: ₹1 Lakh to ₹25 Lakhs</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>Interest Rate: 13.5% to 18.5% p.a.</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div>
                ...
                <ul className="space-y-3 text-text-secondary">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>No collateral required up to ₹15 Lakhs</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Business Types We Support</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6 border border-border rounded-lg">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Retail Business</h3>
                <p className="text-text-secondary text-sm">Shops, boutiques, showrooms</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Service Business</h3>
                <p className="text-text-secondary text-sm">Consulting, repair services</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Manufacturing</h3>
                <p className="text-text-secondary text-sm">Small scale industries</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Home Business</h3>
                <p className="text-text-secondary text-sm">Home-based enterprises</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-text-secondary mb-8 max-w-2xl mx-auto">
              Apply for MNS Bank self-employed loan today and get competitive interest rates, quick approval, and flexible repayment options for your business growth.
            </p>
