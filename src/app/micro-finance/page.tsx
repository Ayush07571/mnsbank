...
export const metadata: Metadata = {
  title: 'Micro Finance | MNS Bank',
  description: 'Get micro finance loans at competitive interest rates with flexible repayment options from MNS Bank Bhopal',
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-white/80">Competitive rates starting from 15.5%</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="container mx-auto px-4 max-w-6xl py-12">
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Micro Finance Features</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div>
                ...
                <ul className="space-y-3 text-text-secondary">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Loan Amount: ₹10,000 to ₹10 Lakhs</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>Interest Rate: 15.5% to 22.5% p.a.</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>Loan Tenure: 6 months to 5 years</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div>
                ...
                <ul className="space-y-3 text-text-secondary">
                  ...
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Group lending facility</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg className="w-5 h-5 text-brand-accent mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <Card className="mb-12">
          <CardHeader>
            <CardTitle className="text-text-primary">Target Groups</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center p-6 border border-border rounded-lg">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Micro Enterprises</h3>
                <p className="text-text-secondary text-sm">Small businesses, artisans</p>
              </div>
              <div className="text-center p-6 border border-border rounded-lg">
                <div className="w-12 h-12 bg-brand-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-brand-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="font-semibold text-text-primary mb-2">Individual Entrepreneurs</h3>
                <p className="text-text-secondary text-sm">Street vendors, home-based businesses</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-text-secondary">
                  <li>• Age: 18 to 60 years</li>
                  <li>• Indian resident</li>
                  <li>• Minimum annual income: ₹1 Lakh</li>
                  <li>• Stable business for minimum 1 year</li>
                  <li>• Good credit history preferred</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-text-primary mb-4">For Groups</h3>
                <ul className="space-y-2 text-text-secondary">
                  <li>• Minimum 5 members in group</li>
                  <li>• Group should be registered</li>
                  <li>• Members should know each other</li>
                  <li>• Regular group meetings</li>
                  <li>• Group leader identification</li>
                </ul>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="mb-12">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Individual Documents</h3>
                <ul className="space-y-2 text-text-secondary">
                  <li>• Identity proof (Aadhaar, PAN, Voter ID)</li>
                  <li>• Address proof (Utility bill, rent agreement)</li>
                  <li>• Business proof (shop license, registration)</li>
                  <li>• Bank statements (last 6 months)</li>
                  <li>• Passport size photographs</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Group Documents</h3>
                <ul className="space-y-2 text-text-secondary">
                  <li>• Group registration certificate</li>
                  <li>• Minutes of group meetings</li>
                  <li>• Bank account details of group</li>
                  <li>• KYC of all group members</li>
                  <li>• Group constitution/rules</li>
                </ul>
              </div>
            </div>
          </CardContent>
