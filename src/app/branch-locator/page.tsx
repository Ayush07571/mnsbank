        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
              Find the nearest MNS Bank branch. Get detailed information about branch services, timings, and directions.
            </p>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-12">
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-text-secondary text-sm">Complete Banking Solutions</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="font-semibold text-text-primary mb-2">Expert Staff</h3>
              <p className="text-text-secondary text-sm">Professional Service</p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <h3 className="font-semibold text-text-primary mb-4">Personal Banking</h3>
                ...
                <div>
                  <h3 className="font-semibold text-text-primary mb-4">Business Banking</h3>
                  <ul className="space-y-2 text-text-secondary">
                    <li className="flex items-center space-x-2">
                      <svg className="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Regular Banking Hours</h3>
              ...
              <div>
                <h3 className="font-semibold text-text-primary mb-4">Special Services Hours</h3>
                <div className="space-y-2">
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Business Banking</span>
                    <span className="font-medium">9:30 AM - 4:30 PM</span>
                  </div>
                </div>
              </div>
