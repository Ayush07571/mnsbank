        ...
        <div className="container mx-auto px-4 max-w-6xl h-full">
          <div className="flex items-center h-full max-w-2xl">
            <div className="text-white">
              <h1 className="font-heading text-4xl md:text-6xl mb-4 animate-fade-in font-bold text-gray-900 dark:text-white text-shadow-lg drop-shadow-2xl bg-white/80 dark:bg-gray-900/80 px-4 py-2 rounded-lg dark:shadow-white/20">
                {currentSlideData.title}
              </h1>
              <h2 className="font-heading text-2xl md:text-3xl mb-6 text-white/95 animate-fade-in-delay font-semibold text-shadow-md drop-shadow-xl">
                {currentSlideData.subtitle}
              </h2>
              <p className="text-xl mb-8 text-white/90 animate-fade-in-delay-2 text-shadow-sm drop-shadow-lg">
      ...
      >
        {isAutoPlaying ? (
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path
              fillRule="evenodd"
              d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zM7 8a1 1 0 012 0v4a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v4a1 1 0 102 0V8a1 1 0 011-1z"
              clipRule="evenodd"
            />
          </svg>
        ) : (
